...
} from '../helpers/screenshot-helper.js';
...
test.describe('Full Journey', () => {
  test('complete primary flow', async ({ page, serverUrl, authToken }) => {
    ...
    await expectPageSnapshot(page, 'journey-01-auth');
    ...
    await expectPageSnapshot(page, 'journey-02-console');
    ...
    await expectPageSnapshot(page, 'journey-03-after-command');
